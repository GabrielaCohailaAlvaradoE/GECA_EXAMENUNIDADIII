...
<body>
    <header>
        <h1>Fase 6 · Empleado</h1>
        <p>El empleado visualiza su boleta desde cualquier dispositivo y registra su firma digital.</p>
    </header>
    <main>
        ...
        <div class="card">
            <div style="display:flex; justify-content: space-between; align-items: center; gap: 1rem; flex-wrap: wrap;">
                <div>
                    ...
                    <p class="muted">Puedes firmar desde cualquier dispositivo. Se almacenará tu IP y hash/token de firma.</p>
                </div>
                <div class="actions">
        ...
        <div class="card">
            ...
            <form method="get" action="${pageContext.request.contextPath}/empleado">
        ...
        <c:if test="${not empty planillaActual}">
            <div class="card">
                ...
                <p class="muted">Al firmar, autorizas recepción y confirmas datos. El PDF final incluirá todas las firmas.</p>
            </div>
            ...
            <div class="card">
                ...
                <form action="${pageContext.request.contextPath}/firmar" method="post">
                    ...
                    <textarea name="observacion" rows="4" style="width:100%; padding:0.5rem;" placeholder="Comentarios opcionales"></textarea>
                    <button class="btn btn-primary" type="submit" style="margin-top:0.7rem; width:100%;">Registrar firma de empleado</button>
                </form>
            </div>
        </c:if>
